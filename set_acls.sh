...
consul acl policy create -name agent -rules 'agent_prefix "" { policy = "write" } event_prefix "" { policy = "read" } key_prefix "" { policy = "write" } keyring = "write" node_prefix "" { policy = "write" } operator = "read" query_prefix "" { policy = "read" } service_prefix "" { policy = "write" }'
consul acl policy create -name admin -rules 'agent_prefix "" { policy = "write" } event_prefix "" { policy = "write" } key_prefix "" { policy = "write" } keyring = "write" node_prefix "" { policy = "write" } operator = "write" query_prefix "" { policy = "write" } service_prefix "" { policy = "write" }'
